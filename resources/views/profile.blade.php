        ...
        <div class="profile-content">
            ...
            <div id="addresses" style="margin-top: 50px;">
                ...
                <div class="address-cards">
                    ...
                    <div class="address-card" style="border: 2px dashed var(--border); display: flex; justify-content: center; align-items: center; cursor: pointer;">
            ...
            <div id="orders" style="margin-top: 50px;">
                ...
                <div class="order-card">
                    ...
                    <div class="order-products">
                        <img src="https://via.placeholder.com/100x100/4CAF50/FFFFFF?text=Apple" alt="Product" class="product-img">
                        <img src="https://via.placeholder.com/100x100/45a049/FFFFFF?text=Banana" alt="Product" class="product-img">
                        <img src="https://via.placeholder.com/100x100/388E3C/FFFFFF?text=Spinach" alt="Product" class="product-img">
                    </div>
                ...
                <div class="order-card">
                    ...
                    <div class="order-products">
                        <img src="https://via.placeholder.com/100x100/4CAF50/FFFFFF?text=Tomato" alt="Product" class="product-img">
                        <img src="https://via.placeholder.com/100x100/45a049/FFFFFF?text=Cucumber" alt="Product" class="product-img">
                    </div>
